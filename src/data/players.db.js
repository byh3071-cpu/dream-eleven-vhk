...
//
// nationality: ISO 3166-1 alpha-2 코드 (assets/flags/<code>.svg, player-schema.js의
// NATIONALITY_NAMES와 1:1 대응). club: 커리어상 가장 상징적인 시절의 소속팀(한글 표기) —
// 실제 엠블럼(로고)은 상표라 안 쓰고 텍스트로만 표시한다.

export const PLAYERS = [
  {
    id: 'buffon', number: 1, name: '잔루이지 부폰', era: 'legend', age: 41,
    nationality: 'it', club: '유벤투스',
    positions: ['GK'],
    stats: { pace: 50, shooting: 20, passing: 60, dribbling: 40, defending: 93, physical: 82 },
    traits: ['veteran_declining'],
  },
  {
    id: 'neuer', number: 1, name: '마누엘 노이어', era: 'active', age: 37,
    nationality: 'de', club: '바이에른 뮌헨',
    positions: ['GK'],
    stats: { pace: 58, shooting: 25, passing: 75, dribbling: 55, defending: 91, physical: 80 },
    traits: [],
  },
  {
    id: 'maldini', number: 3, name: '파올로 말디니', era: 'legend', age: 40,
    nationality: 'it', club: 'AC 밀란',
    positions: ['CB', 'LB'],
    stats: { pace: 78, shooting: 45, passing: 75, dribbling: 65, defending: 95, physical: 85 },
    traits: ['tackle_specialist', 'veteran_declining'],
  },
  {
    id: 'beckenbauer', number: 5, name: '프란츠 베켄바우어', era: 'legend', age: 32,
    nationality: 'de', club: '바이에른 뮌헨',
    positions: ['CB'],
  ...
  {
    id: 'ramos', number: 4, name: '세르히오 라모스', era: 'active', age: 38,
    nationality: 'es', club: '레알 마드리드',
    positions: ['CB'],
    stats: { pace: 72, shooting: 60, passing: 70, dribbling: 62, defending: 90, physical: 88 },
    traits: ['aerial_threat', 'tackle_specialist'],
  },
  {
    id: 'cafu', number: 2, name: '카푸', era: 'legend', age: 34,
    nationality: 'br', club: 'AC 밀란',
    positions: ['RB'],
    stats: { pace: 90, shooting: 55, passing: 72, dribbling: 75, defending: 82, physical: 84 },
    traits: [],
  },
  {
    id: 'roberto_carlos', number: 3, name: '호베르투 카를로스', era: 'legend', age: 31,
    nationality: 'br', club: '레알 마드리드',
    positions: ['LB'],
  ...
  {
    id: 'zidane', number: 10, name: '지네딘 지단', era: 'legend', age: 30,
    nationality: 'fr', club: '레알 마드리드',
    positions: ['CM', 'AM'],
  ...
  {
    id: 'modric', number: 10, name: '루카 모드리치', era: 'active', age: 38,
    nationality: 'hr', club: '레알 마드리드',
    positions: ['CM'],
    stats: { pace: 74, shooting: 72, passing: 90, dribbling: 88, defending: 62, physical: 65 },
    traits: ['playmaker_vision'],
  },
  {
    id: 'xavi', number: 6, name: '사비 에르난데스', shortName: '사비', era: 'legend', age: 32,
  ...
  {
    id: 'iniesta', number: 8, name: '안드레스 이니에스타', era: 'legend', age: 30,
    nationality: 'es', club: 'FC 바르셀로나',
    positions: ['LM', 'AM'],
  ...
  {
    id: 'beckham', number: 7, name: '데이비드 베컴', era: 'legend', age: 29,
  ...
  {
    id: 'messi', number: 10, name: '리오넬 메시', era: 'active', age: 36,
    nationality: 'ar', club: 'FC 바르셀로나',
    positions: ['RW', 'AM'],
  ...
  {
    id: 'mbappe', number: 7, name: '킬리안 음바페', era: 'active', age: 26,
    nationality: 'fr', club: '파리 생제르맹',
    positions: ['LW', 'ST'],
  ...
  {
    id: 'yashin', number: 1, name: '레프 야신', era: 'legend', age: 33,
    nationality: 'ru', club: '디나모 모스크바',
    positions: ['GK'],
    stats: { pace: 55, shooting: 15, passing: 65, dribbling: 45, defending: 94, physical: 80 },
    traits: [],
  },
  {
    id: 'cannavaro', number: 5, name: '파비오 칸나바로', era: 'legend', age: 33,
    nationality: 'it', club: '유벤투스',
    positions: ['CB'],
  ...
  {
    id: 'nesta', number: 13, name: '알레산드로 네스타', era: 'legend', age: 28,
    nationality: 'it', club: 'AC 밀란',
    positions: ['CB'],
  ...
  {
    id: 'lahm', number: 21, name: '필립 람', era: 'legend', age: 30,
    nationality: 'de', club: '바이에른 뮌헨',
    positions: ['RB', 'LB', 'DM'],
  ...
  {
    id: 'matthaus', number: 10, name: '로타어 마테우스', era: 'legend', age: 29,
    nationality: 'de', club: '바이에른 뮌헨',
    positions: ['CM', 'DM'],
  ...
  {
    id: 'henry', number: 14, name: '티에리 앙리', era: 'legend', age: 27,
  ...
  {
    id: 'bergkamp', number: 10, name: '데니스 베르캄프', era: 'legend', age: 29,
    nationality: 'nl', club: '아스널',
    positions: ['AM', 'ST'],
    stats: { pace: 74, shooting: 87, passing: 90, dribbling: 91, defending: 35, physical: 68 },
    traits: ['playmaker_vision', 'dribbler'],
  },
  {
    id: 'puskas', number: 10, name: '페렌츠 푸스카시', era: 'legend', age: 28,
    nationality: 'hu', club: '레알 마드리드',
    positions: ['ST', 'AM'],
    stats: { pace: 78, shooting: 95, passing: 82, dribbling: 84, defending: 30, physical: 76 },
    traits: ['left_footed', 'poacher'],
  },
  {
    id: 'zanetti', number: 4, name: '하비에르 사네티', era: 'legend', age: 27,
    nationality: 'ar', club: '인터 밀란',
    positions: ['RB', 'RM'],
    stats: { pace: 82, shooting: 58, passing: 76, dribbling: 74, defending: 84, physical: 82 },
    traits: ['tackle_specialist'],
  },
  {
    id: 'ronaldinho', number: 10, name: '호나우지뉴', era: 'legend', age: 25,
    nationality: 'br', club: 'FC 바르셀로나',
    positions: ['LW', 'AM'],
    stats: { pace: 87, shooting: 88, passing: 89, dribbling: 96, defending: 32, physical: 76 },
    traits: ['dribbler', 'playmaker_vision'],
  },
  {
    id: 'figo', number: 7, name: '루이스 피구', era: 'legend', age: 28,
    nationality: 'pt', club: '레알 마드리드',
    positions: ['RW', 'RM'],
  ...
  {
    id: 'pirlo', number: 21, name: '안드레아 피를로', era: 'legend', age: 30,
    nationality: 'it', club: '유벤투스',
    positions: ['CM', 'DM'],
  ...
  {
    id: 'xabi_alonso', number: 14, name: '사비 알론소', era: 'legend', age: 27,
    nationality: 'es', club: '리버풀',
    positions: ['DM', 'CM'],
    stats: { pace: 68, shooting: 76, passing: 92, dribbling: 72, defending: 76, physical: 76 },
    traits: ['playmaker_vision', 'tackle_specialist'],
  },
  {
    id: 'gattuso', number: 8, name: '젠나로 가투소', era: 'legend', age: 27,
    nationality: 'it', club: 'AC 밀란',
    positions: ['DM', 'CM'],
  ...
  {
    id: 'totti', number: 10, name: '프란체스코 토티', era: 'legend', age: 26,
    nationality: 'it', club: 'AS 로마',
    positions: ['AM', 'ST'],
    stats: { pace: 76, shooting: 88, passing: 88, dribbling: 85, defending: 38, physical: 76 },
    traits: ['playmaker_vision', 'free_kick_specialist'],
  },
  {
    id: 'rivaldo', number: 10, name: '히바우두', era: 'legend', age: 27,
    nationality: 'br', club: 'FC 바르셀로나',
    positions: ['LW', 'AM'],
  ...
  {
    id: 'lampard', number: 8, name: '프랭크 램파드', era: 'legend', age: 28,
  ...
  {
    id: 'gerrard', number: 8, name: '스티븐 제라드', era: 'legend', age: 25,
  ...
  {
    id: 'scholes', number: 18, name: '폴 스콜스', era: 'legend', age: 26,
    nationality: 'gb-eng', club: '맨체스터 유나이티드',
    positions: ['CM'],
  ...
  {
    id: 'nedved', number: 11, name: '파벨 네드베드', era: 'legend', age: 31,
    nationality: 'cz', club: '유벤투스',
    positions: ['LM', 'AM'],
    stats: { pace: 84, shooting: 82, passing: 79, dribbling: 84, defending: 55, physical: 84 },
    traits: ['left_footed', 'dribbler'],
  },
  {
    id: 'baggio', number: 10, name: '로베르토 바조', era: 'legend', age: 26,
    nationality: 'it', club: '피오렌티나',
    positions: ['AM', 'ST'],
  ...
  {
    id: 'kim_minjae', number: 3, name: '김민재', era: 'active', age: 27,
    nationality: 'kr', club: '나폴리',
    positions: ['CB'],
    stats: { pace: 82, shooting: 35, passing: 76, dribbling: 68, defending: 90, physical: 88 },
    traits: ['tackle_specialist', 'aerial_threat'],
  },
  {
    id: 'son_heungmin', number: 7, name: '손흥민', era: 'active', age: 31,
    nationality: 'kr', club: '토트넘 홋스퍼',
    positions: ['LW', 'ST'],
  ...
  },
  {
    ...
    nationality: 'kr', club: '아인트라흐트 프랑크푸르트',
    positions: ['ST', 'LW'],
  ...
  },
  {
    ...
    nationality: 'kr', club: '수원 삼성 블루윙즈',
    positions: ['RB', 'RM'],
    stats: { pace: 84, shooting: 62, passing: 68, dribbling: 74, defending: 68, physical: 76 },
    traits: [],
  },
  {
    id: 'lee_youngpyo', number: 12, name: '이영표', era: 'legend', age: 25,
    nationality: 'kr', club: 'PSV 에인트호번',
    positions: ['LB'],
  ...
  },
  {
    ...
    nationality: 'kr', club: '페루자',
    positions: ['ST'],
    stats: { pace: 82, shooting: 84, passing: 68, dribbling: 78, defending: 32, physical: 74 },
    traits: ['poacher'],
  },
  {
    id: 'hong_myungbo', number: 20, name: '홍명보', era: 'legend', age: 30,
    nationality: 'kr', club: '포항 스틸러스',
    positions: ['CB', 'DM'],
    stats: { pace: 70, shooting: 50, passing: 76, dribbling: 62, defending: 88, physical: 80 },
    traits: ['tackle_specialist', 'playmaker_vision'],
  },
  {
    id: 'yoo_sangchul', number: 6, name: '유상철', era: 'legend', age: 30,
    nationality: 'kr', club: '울산 현대',
    positions: ['CM', 'DM'],
    stats: { pace: 74, shooting: 72, passing: 70, dribbling: 70, defending: 70, physical: 82 },
    traits: ['tackle_specialist'],
  },
  {
    id: 'lee_woonjae', number: 1, name: '이운재', era: 'legend', age: 29,
    nationality: 'kr', club: '수원 삼성 블루윙즈',
    positions: ['GK'],
  ...
  {
    id: 'maicon', number: 13, name: '마이콘', era: 'legend', age: 29,
    nationality: 'br', club: '인터 밀란',
    positions: ['RB'],
  ...
  {
    id: 'ashley_cole', number: 3, name: '애슐리 콜', era: 'legend', age: 24,
  ...
  {
    id: 'carvajal', number: 2, name: '다니 카르바할', era: 'active', age: 28,
    nationality: 'es', club: '레알 마드리드',
    positions: ['RB'],
  ...
  {
    id: 'marcelo', number: 12, name: '마르셀로', era: 'legend', age: 27,
    nationality: 'br', club: '레알 마드리드',
    positions: ['LB'],
  ...
  {
    id: 'gary_neville', number: 2, name: '개리 네빌', era: 'legend', age: 26,
    nationality: 'gb-eng', club: '맨체스터 유나이티드',
    positions: ['RB'],
  ...
  {
    id: 'jordi_alba', number: 18, name: '조르디 알바', era: 'active', age: 27,
    nationality: 'es', club: 'FC 바르셀로나',
    positions: ['LB'],
  ...
  {
    id: 'giggs', number: 11, name: '라이언 긱스', era: 'legend', age: 27,
  ...
  {
    id: 'rivelino', number: 11, name: '히벨리누', era: 'legend', age: 24,
  ...
  {
    id: 'pires', number: 7, name: '호베르 피레스', era: 'legend', age: 30,
    nationality: 'fr', club: '아스널',
    positions: ['LM', 'LW'],
