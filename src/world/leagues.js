...
export const LEAGUES = [
  ...
  // ─── 확장 예정 ───────────────────────────────────────────
  // J 글로리(일 20팀·rounds:2·득실차우선·제휴국무제한), E 프리미어(영 20팀·홈그로운),
  // S 리가(스 20팀·승자승우선·샐러리캡) = docs/world/{japan,england,spain}-league.md 참조.
  // 35개국은 국가 프로필(리그명·도시풀·강도·스타일) + 생성기로 추가.
]
